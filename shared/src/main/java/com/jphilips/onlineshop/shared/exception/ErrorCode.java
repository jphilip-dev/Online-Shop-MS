...
public enum ErrorCode {
    ...
    CHECKOUT_ERROR(HttpStatus.BAD_REQUEST, "ERROR_CHECKOUT"),

    CART_CHECKOUT_ERROR(HttpStatus.BAD_REQUEST, "ERROR_CART_ITEM_CHECKOUT"),
    CART_ITEM_NOT_FOUND(HttpStatus.NOT_FOUND, "ERROR_CART_ITEM_NOT_FOUND"),
    CART_ITEM_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "ERROR_CART_ITEM_NOT_AVAILABLE"),
    CART_ITEM_MORE_THAN_STOCKS(HttpStatus.BAD_REQUEST, "ERROR_CART_ITEM_STOCK_LOW");
